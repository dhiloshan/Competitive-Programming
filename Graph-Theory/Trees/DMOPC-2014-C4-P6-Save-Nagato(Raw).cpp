// DMOPC '14 Contest 4 P6 - Save Nagato! (DMOJ): https://dmoj.ca/problem/dmopc14c4p6
// RAW CODE (find tree diameter, for each node max dist is either node x to one end or node x to other end of the diameter)
#include <bits/stdc++.h>
using namespace std;
